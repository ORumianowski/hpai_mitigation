...
gillespie_seir = function(param, 
  ...
  # Initialization
  times = c(0)
  states = array(dim = c(4,5,1), data = initial_state)
  already_dispersed = F
  ...
  while (times[length(times)] < total_time) {
    ...
    rates = c(
      "S_a_to_E_a" = beta_E_colony * S_a * E_a + beta_I_colony * S_a * I_a,
      "E_a_to_S_a" = eta * E_a,
      ...
      "S_b_to_E_b" = beta_E_colony * S_b * E_b + beta_I_colony * S_b * I_b,
      "E_b_to_S_b" = eta * E_b,
