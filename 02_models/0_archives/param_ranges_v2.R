...
param_ranges = list(
  ...
  # Integer parameters
  initial_number_infected_breeders_A = list(range = c(0, 10), distribution = "integer"),
  ...
  initial_number_breeders_A = list(range = c(30, 70), distribution = "integer"),
  initial_number_breeders_B = list(range = c(50, 80), distribution = "integer"),
  initial_number_breeders_C = list(range = c(50, 20), distribution = "integer"),
  dispersal_reaction_time =  list(range = c(1, 8), distribution = "integer"),
  dispersal_date = list(range = c(0, 0), distribution = "integer"),
  hatching_date = list(range = c(0, 30), distribution = "integer"),
  ...
  adult_mortality = list(range = c(0, 1), distribution = "simple_uniform"),
  nestling_mortality = list(range = c(0.5, 1.0), distribution = "simple_uniform"),
  ...
  theta = list(range = c(1/100, 1/1), distribution = "logarithmic"),
