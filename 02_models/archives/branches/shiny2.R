...
ui <- fluidPage(
  theme = shinytheme("cyborg"), # You can choose other themes like "spacelab", "united", etc.
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("selected_output", "Select Output:", 
                  choices = c("BO_nb_adults_equi", "BO_RS_nb_adults_equi", "BO_P2_nb_adults_equi"),
      ...
      sliderInput("beta_I_colony_range", 
                  ...
                  step = diff(range(dt2$beta_I_colony))/12),
...
#   sidebarLayout(
#     sidebarPanel(
#       sliderInput("n_bins", "Number of Bins:", min = 4, max = 20, value = 10),
#       selectInput("selected_output", "Select Outpur:", choices = c("BO_nb_adults_equi",
#                                                                    "BO_RS_nb_adults_equi",
#                                                                    "BO_P2_nb_adults_equi"),
#                   selected = "BO_P2_nb_adults_equi"),
#       sliderInput("initial_number_infected_breeders_A_range", 
#                   "Number of infected breeders introduced initially", 
#                   min = min(dt2$initial_number_infected_breeders_A), 
